      ...
      <React.Fragment>
          ...
          <div className="shopping-cart" id="strt">
                  ...
                  {basket.map((item, index) => (
                      <div key={index} className="product">
                          ...
                          <div className="product-removal">
                              <button className="remove-product" onClick={() => remove(index)}>
                                  Remove
                              </button>
                          </div>
              ...
              <div className="totals">
                  ...
                  <div className="totals-item">
                      <label>Tax (5%)</label>
                      <div className="totals-value" id="cart-tax">{memoizedTotal * shipping}</div>
                  </div>
                  <div className="totals-item">
                      <label>Delivery</label>
                      <div className="totals-value" id="cart-shipping">{delivery}</div>
                  </div>
                  <div className="totals-item totals-item-total">
                      <label>Grand Total</label>
                      <div className="totals-value" id="cart-total">{memoizedTotal + memoizedTotal*shipping + delivery}</div>
                  </div>
              </div>
