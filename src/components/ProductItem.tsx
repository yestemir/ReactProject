...
export default class ProductItem extends Component<Props, State> {
    ...
    render() {
        ...
        return (
            <>
                    <div className="col-10 col-sm-6 col-lg-4 mx-auto my-3 store-item" data-item="sweets">
                        <div id="001" className="card">
                            <div className="img-container" >
                                <img src={this.state.item.image} className="card-img-top store-img"/>
                            </div>
                            <div className="card-body">
                                <div className="card-text d-flex justify-content-between text-capitalize">
                                    ...
                                    <h5 className="store-item-value">$ <strong id="store-item-price" className="font-weight-bold">{this.state.item.price}</strong></h5>
                                </div>
                                <div className='productDescriptionDiv' >
                                    <button className='addToCart' onClick={() => this.props.addItem(item)} style={{
